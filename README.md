...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <h4>✨ Key Features:</h4>
      <ul>
        <li>⚽ Interactive squad builder</li>
        <li>🧠 Tactical lineup planning</li>
...
> **"I believe great software is built by combining clean code, continuous learning, and real-world problem solving."**
...
| :--- | :--- |
| **🔷 TypeScript** | Advanced Type Safety & Architecture |
| **🤖 AI** | AI Integration & AI-Powered Applications |
| **🧠 DSA** | Problem Solving & Algorithms |
| **⚡ Next.js** | Advanced App Architecture |
| **🔐 Authentication** | Secure Application Architecture |
| **🏗️ System Design** | Scalable Web Applications |
...
<div align="center">
  <p>I'm always interested in connecting with developers, recruiters, founders, and teams working on meaningful products.</p>
  <br/>
